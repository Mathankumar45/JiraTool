    ...
    <div class="row">
      <div class="col-md-6">
        <div class="contact-detail">
          ...
          <ul class="contact-ul">
            <li><i class="fa fa-location-dot"></i>1st Floor, No.2A Duraisamy, Reddy St, Near Passport Seva, Tambaram West, Chennai, Tamil Nadu 600045</li>
            ...
            <li>
              ...
              <a href="mailto:besant@gmail.com"><b> demounknown@gmail.com</b></a>
            </li>
          </ul>
